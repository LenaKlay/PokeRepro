...
When you use a package you have to add it to the DESCRIPTION FILE. Do do so you can right in the consol `usethis:use_package(random_name_of_package)` instead of `install.package()`
