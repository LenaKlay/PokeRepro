...
So yay! First R analysis created! Now, you have to create as many functions and as many analysis as needed in your Research Compendium and then, have a look at the [Create an automatised workflow: using make.R or the targets package tutorial](https://poke-reproducibility.netlify.app/2021/11/29/create-an-automatised-workflow-using-make.r-or-the-targets-package/).
...
pokemon datasets (`poke.plot01()` function)
...
You can have a look at these functions and analysis script to be sure to fully
