...
Each tutorial contains R chunks so you can run the analysis using a **Pokemon dataset** from the Kaggle website ([link](https://www.kaggle.com/rounakbanik/pokemon))
