...
Each tutorial contains R chunks so you can run the analysis using a **Pokemon dataset** from the Kaggle website ([link](https://www.kaggle.com/rounakbanik/pokemon)) which gathers informations like Basic Statistics, Type, Height, Weight *etc* for 802 Pokemons.
...
* 4 - Create an automatised workflow: using make.R or the targets package
